...
public class Cruise1 {
	...
	public Cruise1(String[] cruiseName, double[] priceAdult, double[] priceChild, int[] noOfDays) {
		super();
		...
		for (int i = 0; i < cruiseName.length; i++) {
			if (cruiseSelected.equalsIgnoreCase(cruiseName[i])) {
				...
				System.out.println("The cruise that you have selected is " + cruiseName[i] + " which is " + noOfDays[i]
						+ " day cruise");
				System.out.println("Price for Adults(greateer than 12)   : " + priceAdult[i] + " per day");
